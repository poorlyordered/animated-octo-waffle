# Tasks: M43 Opportunity Ingestion Expansion

**Input**: Design documents from `specs/043-opportunity-ingestion-expansion/`

## Phase 1: Setup

- [x] T001 Create M43 Spec Kit artifacts.
- [x] T002 Update active feature pointer and agent guide to M43.

## Phase 2: Implementation

- [x] T003 Add Opportunity ingestion prepare and worker contracts/schemas.
- [x] T004 Extend Opportunity ingestion history store with prepare and worker lifecycle helpers.
...
- [x] T010 Update `docs/roadmap.md`, `README.md`, `AGENTS.md`, and `.specify/feature.json` for M43 completion.
